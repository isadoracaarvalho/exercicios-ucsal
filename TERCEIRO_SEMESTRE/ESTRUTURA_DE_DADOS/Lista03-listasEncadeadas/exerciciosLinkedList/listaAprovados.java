...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        for(int i = 0; i < qtdVagas; i++) {
            String nomeAprovado = sc.nextLine();
            lista.addLast(nomeAprovado);

            if (nomeAprovado.equals(nome)) {
                passou = lista.contains(nome);
            }
        }
        ...
        if (passou) {
            ...
            System.out.println("Vamos esperar a 2a chamada");
        }
    }
